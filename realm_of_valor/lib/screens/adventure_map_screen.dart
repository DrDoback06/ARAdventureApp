...
import '../widgets/trail_card_widget.dart';
...
class _AdventureMapScreenState extends State<AdventureMapScreen>
  ...
  late PhysicalActivityService _activityService;
  ...
  void didChangeDependencies() {
    ...
    _stravaService = Provider.of<StravaService>(context, listen: false);
    _activityService = Provider.of<PhysicalActivityService>(context, listen: false);
  ...
  void _showTrailAdventure(String trailName) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: Text('Adventure: $trailName'),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            const Text('Transform this trail into an epic adventure quest!'),
            const SizedBox(height: 16),
            const Text('Quest Objectives:', style: TextStyle(fontWeight: FontWeight.bold)),
            const Text('• Reach the trailhead (25 XP)'),
            const Text('• Complete the full trail (150 XP)'),
            const Text('• Discover hidden features (50 XP each)'),
            const Text('• Take photos at viewpoints (25 XP each)'),
            const SizedBox(height: 16),
            const Text('Rewards:', style: TextStyle(fontWeight: FontWeight.bold)),
            const Text('• Trail Conqueror title'),
            const Text('• Adventure XP bonus'),
            const Text('• Real-world fitness tracking'),
          ],
        ),
        actions: [
          TextButton(
          ...
          ElevatedButton(
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text('Adventure quest "$trailName" started! 🎯'),
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            const Spacer(),
                            IconButton(
                              onPressed: () => setState(() => _showTrails = false),
                        ...
                        child: ListView(
                          ...
                          children: [
                            TrailCardWidget(
                              ...
                              description: 'A magical journey through ancient woodlands with hidden waterfalls.',
                              lengthKm: 5.2,
                              elevationGainM: 300,
                              difficulty: 'moderate',
                              rating: 4.7,
                              reviewCount: 128,
                              onTap: () => _showTrailAdventure('Mystic Forest Loop'),
                            ),
                            TrailCardWidget(
                              ...
                              rating: 4.9,
                              reviewCount: 89,
                              onTap: () => _showTrailAdventure('Dragon\'s Peak Trail'),
                            ),
                            TrailCardWidget(
                              name: 'Riverside Walk',
                              description: 'Gentle path following the river with wildlife viewing opportunities.',
                              lengthKm: 3.1,
                              elevationGainM: 50,
                              difficulty: 'easy',
                              rating: 4.3,
                              reviewCount: 245,
                              onTap: () => _showTrailAdventure('Riverside Walk'),
                            ),
                          ],
                        ),
                      ),
            ...
            child: Column(
              children: [
                ...
                FloatingActionButton(
                  ...
                  backgroundColor: _showTrails ? Colors.brown : Colors.grey,
